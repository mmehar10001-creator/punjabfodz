    ...
    <header className="absolute top-0 left-0 right-0 z-50">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <nav className="hidden gap-8 md:flex">
          ...
          <Link to="/menu" className={linkCls}>
            Menu
          </Link>
          <Link to="/catering" className={linkCls}>
            Catering / Deg
          </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            href="https://wa.me/923437117361?text=Hello!%20I%27d%20like%20to%20place%20an%20order%20at%20Punjab%20Foods."
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="flex items-center justify-center h-9 w-9 rounded-full bg-[#25D366] text-white hover:scale-105 transition-transform"
          >
            <svg
