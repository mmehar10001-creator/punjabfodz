  ...
  head: () => ({
    meta: [
      { title: "Contact — Punjab Foods" },
      {
        name: "description",
        content:
          "Call Punjab Foods at 051-5706222 for home delivery in Rawalpindi. Visit us at Sirsyed Chowk, Tipu Road.",
      },
      { property: "og:title", content: "Contact — Punjab Foods" },
      {
        property: "og:description",
        content: "Home delivery & location details for Punjab Foods, Rawalpindi.",
      },
    ],
  }),
  component: Contact,
      ...
      <section className="pt-40 pb-24 px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground text-lg">
            Home delivery, dine-in & catering orders welcome.
          </p>
        </div>
        ...
        <div className="mx-auto max-w-4xl mt-16 grid md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              {contact.phones.map((p) => (
                <a
                  ...
                  className="block font-serif text-2xl hover:text-primary transition-colors"
                >
                  {p}
                </a>
              ))}
          ...
          <div className="border border-border p-10 bg-card">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-md hover:scale-105 transition-transform"
            >
              <svg
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Message us for quick orders & catering bookings.
            </p>
          </div>
          <div className="border border-border p-10 bg-card">
